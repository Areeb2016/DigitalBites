...
export default class Categories extends Component {
 ...
 this. state = {
  ...
  handleClickconfirm = async() => {    
    ...
    const url = 'https://digitalbites.herokuapp.com/orders/update/'+ this.props.route.params.itemId ;
    axios.patch(url, { status:'Completed' },{"headers" : headers})
    .then(result => {     
 ...
 onloadtotal()
{
  ...
  render() {
    ...
    return (
        ...
        <Left>
              <Icon name='arrow-back' style={{color:'white'}} onPress={()=>this.props.navigation.navigate("dashboard")}/>
          </Left>
          <Body>
